    ...
    id: {
        ...
        admin: {
            ...
            lines: [
                ...
                "`/services-setup` — post panel katalog jasa ke sebuah channel (auto-update tiap harga berubah)",
    ...
    en: {
        ...
        admin: {
            ...
            lines: [
                ...
                "`/services-setup` — post the service catalog panel to a channel (auto-updates when prices change)",
